...
public class MainActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mGetAtrButton.setOnClickListener(new View.OnClickListener() {
        ...
        mGetFeaturesButton.setOnClickListener(new View.OnClickListener() {
        ...
        mVerifyPinButton.setOnClickListener(new View.OnClickListener() {
        ...
        mModifyPinButton.setOnClickListener(new View.OnClickListener() {
        ...
        mReadKeyButton.setOnClickListener(new View.OnClickListener() {
        ...
        mDisplayLcdMessageButton.setOnClickListener(new View.OnClickListener() {
